...
Validator.prototype.compileSchemaObject = function(schemaObject) {
	...
	this.generateCheckSchemaObject(sourceCode, compiledObject.properties, true);
	sourceCode.push("} else {");
	this.generateCheckSchemaObject(sourceCode, compiledObject.properties, false);
	sourceCode.push("}");
...
Validator.prototype.generateCheckSchemaObject = function(sourceCode, properties, withConverted) {
